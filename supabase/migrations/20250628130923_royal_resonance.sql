/*
  # Sistema RH - Schema Inicial Completo
...
CREATE TABLE IF NOT EXISTS reminders (
    id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    candidate_id uuid REFERENCES reminders(id) ON DELETE CASCADE,
...
-- Corrigir foreign key da tabela reminders
ALTER TABLE reminders DROP CONSTRAINT IF EXISTS reminders_candidate_id_fkey;
